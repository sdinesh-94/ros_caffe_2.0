...
int main(int argc, char** argv) {
   ...
   string model_path,weights_path,mean_path,label_path,image_path;
   const std::string ROOT_SAMPLE = ros::package::getPath("ros_caffe");
    ...
    mean_path = ROOT_SAMPLE + "/data/imagenet_mean.binaryproto";
    label_path = ROOT_SAMPLE + "/data/synset_words.txt";
    image_path = ROOT_SAMPLE + "/data/cat.jpg";
  Classifier classifier(model_path, weights_path, mean_path, label_path);
